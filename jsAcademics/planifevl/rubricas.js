  ...
  async function fetchDataAndFormatRubricas() {
    ...
    try {
      ...
      document.getElementById(
        "tableContentRubricas"
      ).innerHTML = `Error al obtener datos: ${error.message}`;
    } finally {
      document.getElementById("loadingOverlayRubricas").style.display =
        "none";
    }
  }
  ...
  async function SpinnerRubricas() {
    ...
    document.getElementById("tableContentRubricas").innerHTML =
      "Cargando Contenido ...";
    try {
