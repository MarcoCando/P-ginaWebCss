...
async function fetchAndDisplayEvaluacion() {
  ...
  const body = {
    parte1:
      document.getElementById('txtActividades1').value,
    parte2:
      document.getElementById('txtActividades2').value,
    parte3:
      document.getElementById('txtActividades3').value,
    parte4:
      document.getElementById('txtActividades4').value,
    porcentajes:
